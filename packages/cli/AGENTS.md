...
<description>test-skill skill</description>
<path>.openskills/test-skill/SKILL.md</path>
</skill>

<skill activation="lazy">
<name>complex-skill</name>
<description>complex-skill skill</description>
<path>.cursor/rules/SKILL.md</path>
</skill>

<skill activation="lazy">
<name>legacy-skill</name>
<description>legacy-skill skill</description>
<path>.openskills/legacy-skill/SKILL.md</path>
</skill>

<skill activation="lazy">
<name>claude-skill</name>
<description>copilot-test skill</description>
<path>.github/instructions/SKILL.md</path>
</skill>

<skill activation="lazy">
<name>claude-pkg</name>
<description>claude-pkg skill</description>
<path>.openskills/claude-pkg/SKILL.md</path>
</skill>
...
<name>complex-agent</name>
<description>complex-agent agent</description>
<path>.openagents/complex-agent/AGENT.md</path>
</agent>

<agent activation="lazy">
<name>claude-agent</name>
<description>claude-agent agent</description>
<path>.cursor/agents/AGENT.md</path>
</agent>
